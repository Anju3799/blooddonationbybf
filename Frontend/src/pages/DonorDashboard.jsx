...
import { Heart, Droplet, LogOut, User } from "lucide-react";
import { useNavigate } from "react-router-dom";
...
const DonorDashboard = () => {
  ...
  // Load logged-in donor from localStorage
  useEffect(() => {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-red-50 to-pink-50 px-6 py-10">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 flex flex-col md:flex-row items-center justify-between">
            ...
            <button
              onClick={handleLogout}
              className="mt-4 md:mt-0 flex items-center gap-2 bg-red-600 text-white px-5 py-2 rounded-lg hover:bg-red-700 transition"
            >
              <LogOut size={18} />
              Logout
            </button>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 mt-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <button className="bg-red-600 text-white p-6 rounded-xl hover:bg-red-700 transition shadow-md hover:shadow-xl">
                <h3 className="text-xl font-semibold mb-2">
                  Donate Blood
                </h3>
                <p className="text-sm opacity-90">
                  Schedule your next blood donation and save lives.
                </p>
              </button>

              <button className="bg-white border-2 border-red-600 text-red-600 p-6 rounded-xl hover:bg-red-50 transition shadow-md hover:shadow-xl">
                <h3 className="text-xl font-semibold mb-2">
                  Update Profile
                </h3>
                <p className="text-sm opacity-90">
          ...
          <div className="text-center mt-12">
            <p className="text-gray-600 text-lg">
              🩸 <span className="font-semibold text-red-600">One donation</span>{" "}
              can save up to{" "}
              <span className="font-semibold text-red-600">three lives</span>.
            </p>
          </div>
        </div>
      </div>
